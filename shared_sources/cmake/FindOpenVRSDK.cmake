...
if( DEFINED ENV{OPENVRSDK_LOCATION} )
  set(OPENVRSDK_LOCATION "$ENV{OPENVRSDK_LOCATION}")
endif()

set(OPENVRSDK_LOCATION "${OPENVRSDK_LOCATION}" CACHE PATH "OpenVR SDK root directory")
